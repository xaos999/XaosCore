...
const char * const PIVX_CONF_FILENAME = "xaos.conf";
const char * const PIVX_PID_FILENAME = "xaos.pid";
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\xaos
// Windows >= Vista: C:\Users\Username\AppData\Roaming\xaos
// Mac: ~/Library/Application Support/xaos
// Unix: ~/.xaos
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Xaos";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty xaos.conf if it does not exist
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override xaos.conf
