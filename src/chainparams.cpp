...
{
    const char* pszTimestamp = "Before the sea and the lands and that which covers all the sky there was only one face of nature in the world, what to call chaos: raw and indigestible mass and nothing but an inert weight accumulated in the same the seeds of discord are not well united.";
    const CScript genesisOutputScript = CScript() << ParseHex("042d8769f6a356f8cc95b4046b7c21cc62a390c4bdf707ff167820509ac37d676a11b8893e34deecaf37ff68b16e6a3109ce12bf5ba1be9457ee4801e96fa0dec4") << OP_CHECKSIG;
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1676168004, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1676168004, 580458, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        consensus.nMaxMoneyOut = 49000000 * COIN;
        ...
        // spork keys
        consensus.strSporkPubKey = "0479bb3f6be00dd5de68699195b7473efa9d7a9e8f392eaa45125f12fd34ea9ec1965f0088bf65e3df6791dae327d37873f515593e809c0285a18dc3bd8d9f2076";
        ...
        consensus.mBurnAddresses = {
           { "xXXXXXXXXXXXXXXXXXXXXXXXXXXXVtkn93", 0 }
        };
...
public:
    CTestNetParams()
    {
        ...
        genesis = CreateGenesisBlock(1676168004, 2402015, 0x1e0ffff0, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x0000041e482b9b9691d98eefb48473405c0b8ec31b76df3797c74a78680ef818"));
        //assert(genesis.hashMerkleRoot == uint256S("0x1b2ef6e2f28be914103a277377ae7729dcd125dfeb8bf97bd5964ba72b6dc39b"));

        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // xaos starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        // spork keys
        consensus.strSporkPubKey = "04e11a96cf1006969b490db3481fe4736fc77130595516fe7b774482ea89e7efd08fd05ea566bbbf6acb76594e7e55603a97f3531d1fe77d2ddd5706766b1c3af2";
        consensus.strSporkPubKeyOld = "";
        consensus.nTime_EnforceNewSporkKey = 0;
        consensus.nTime_RejectOldSporkKey = 0;
        ...
        vSeeds.push_back(CDNSSeedData("tseeder", "tseeder.xaos.net"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet xaos addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet xaos script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet xaos BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet xaos BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet xaos BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        */
        consensus.strSporkPubKey = "043d80455ca78624032b88a8c5b323393c98be6ab63d511084c9a9a540e340abe7a3eee2005df54ffc54be8d1700ae592b363ec18b41fc10611bd69dfc1a69cfa3";
        consensus.strSporkPubKeyOld = "";
        consensus.nTime_EnforceNewSporkKey = 0;
        consensus.nTime_RejectOldSporkKey = 0;
